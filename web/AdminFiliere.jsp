...
<html>
    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <ul class="nav_list" >
                ...
                <li>
                    ...
                    <a  href="/AnnuaireENSProject/AdminePage/Administration/Filiere" style="color:rgb(18, 142, 224);background:white;">
        ...
        <!-- ************************Contenu************************* -->
        <div class="sec">
            <h2>Ajouter nouveau filière:</h2>
            <center>
                
                <form id="contact" action="/AnnuaireENSProject/AdminePage/Administration/Filiere" method="post">

                    <fieldset>
                        <select class="form-control" name="departement" required="" autofocus="">
                    ...
                    <fieldset>
                        <input placeholder="Nom de Filière" name="filiere"  type="text" tabindex="1" required autofocus>
                    </fieldset>
