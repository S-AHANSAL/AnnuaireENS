...
<html>
    ...
    <body>
        ...
        <nav class="topnav" id="myTopnav">
            ...
            <ul class="opera" >
                <li  class="operaActive"><a href="/AnnuaireENSProject/AdminePage/Utilisation/Etudiant">Utilisation</a></li>
                <li><a href="/AnnuaireENSProject/AdminePage/Administration/Etudiant">Administration</a></li>
            </ul>
        ...
        <div class="sidebar">
            ...
            <ul class="nav_list" >
                ...
                <br>    
                <li>
                    <a href="/AnnuaireENSProject/AdminePage/Utilisation/Etudiant" style="color:rgb(18, 142, 224);background:white;">
                ...
                <br>
                <li>
                    <a href="/AnnuaireENSProject/AdminePage/Utilisation/Departement">
                ...
                <li>
                    ...
                    <a  href="/AnnuaireENSProject/AdminePage/Utilisation/Filiere">
        ...
        <div class="sec">
            <div class="flex">
                ...
                <div class="wrap" style="display:none;">
                    <div class="search">
                        <input type="text" class="searchTerm" onkeyup="EtudiantRecherche(this.value)" placeholder="Recherche ....">
                ...
                <tbody id="Result">
                    ...
                    <c:forEach var="etudiant" items="${ etudiants }">
                        <tr>
                            ...
                            <td><c:out value="${ etudiant.nom }" /> <c:out value="${ etudiant.prenom }" /> </td>
                            <td><c:out value="${ etudiant.cne }" /></td>
                            <td><c:out value="${ etudiant.telephone }" /></td> 
                            <td><c:out value="${ etudiant.nom_d }" /></td>  
                            <td><c:out value="${ etudiant.nom_f }" /></td>  
...
// sidebar
            ...
            function EtudiantRecherche(str) {
                const xmlhttp = new XMLHttpRequest();
                xmlhttp.onload = function () {
                    document.getElementById("Result").innerHTML = this.responseText;
                }
                xmlhttp.open("GET", "/AnnuaireENSProject/EtudiantRecherche?mot=" + str);
                xmlhttp.send();
            }
