    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <ul class="nav_list" >
                ...
                <br>
                <li>
                    <a href="/AnnuaireENSProject/AdminePage/Utilisation/Departement"  style="color:rgb(18, 142, 224);background:white;">
        ...
        <div class="sec">
            <div class="flex">
                ...
                <div class="wrap">
                    <div class="search">
                        <input type="text" class="searchTerm" onkeyup="DepartementRecherche(this.value)" placeholder="Recherche ....">
              ...
              <c:set var="i" value="1" scope="page"/>
                <c:forEach var="departement" items="${ departements }">
                    <tr>
                        ...
                        <td><c:out value="${ departement.date }" /></td>
...
// sidebar
            ...
            function DepartementRecherche(str) {
                const xmlhttp = new XMLHttpRequest();
                xmlhttp.onload = function () {
                    document.getElementById("Result").innerHTML = this.responseText;
                }
                xmlhttp.open("GET", "/AnnuaireENSProject/DepartementRecherche?mot=" + str);
                xmlhttp.send();
            }
        </script>
    </body>
