    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <ul class="nav_list" >
                ...
                <br>    
                <li>
                    <a href="/AnnuaireENSProject/AdminePage/Administration/Etudiant" style="color:rgb(18, 142, 224);background:white;" >
                ...
                <br>
                <li>
                    <a href="/AnnuaireENSProject/AdminePage/Administration/Departement"  >
        ...
        <div class="sec">
            ...
            <h2>Ajouter nouveau etudiant:</h2>
            <center>
                <form id="contact" action="/AnnuaireENSProject/AdminePage/Administration/Etudiant" method="post">
                    <fieldset>
                        <input placeholder="CNE" name="cne"  type="text" tabindex="1" required autofocus>
                    </fieldset>
                    <fieldset>
                        <input placeholder="Nom" name="nom"  type="text" tabindex="1" required autofocus>
                    </fieldset
                    <fieldset>
                        <input placeholder="Prenom" name="prenom"  type="text" tabindex="1" required autofocus>
                    </fieldset>
                    <fieldset>
                        <input placeholder="Téléphone" name="telephone"  type="text" tabindex="1" required autofocus>
                    </fieldset>
                    <fieldset>
                        <select class="form-control" name="departement" required="" autofocus="" onclick="showFilier(this.value)">
                            <option disabled>Choisissez un département</option>
                            <c:forEach var="departement" items="${ departements }">
                                <option value="<c:out value="${ departement.id }" />"> <c:out value="${ departement.nom }" /></option>
                            </c:forEach>
                        </select>
                    </fieldset>
                    <fieldset id="selectFilier">
                        <select class="form-control" name="filiere" required="" autofocus="">
                            <option disabled>Choisissez un filière</option>
                        </select>
                    </fieldset>
                    <fieldset>
...
// sidebar
            ...
            function showFilier(str) {
                if (str.length == 0 || str == 0) {
                    document.getElementById("selectFilier").innerHTML = "";
                    return;
                } else {
                    const xmlhttp = new XMLHttpRequest();
                    xmlhttp.onload = function () {
                        document.getElementById("selectFilier").innerHTML = this.responseText;
                    }
                    xmlhttp.open("GET", "/AnnuaireENSProject/SelectFilier?id=" + str);
                    xmlhttp.send();
                }
            }
        </script>
