    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <ul class="nav_list" >
                ...
                <br>    
                <li>
                    <a href="/AnnuaireENSProject/AdminePage/Utilisation/Etudiant" >
                ...
                <li>
                    ...
                    <a  href="/AnnuaireENSProject/AdminePage/Utilisation/Filiere" style="color:rgb(18, 142, 224);background:white;">
        ...
        <div class="sec">
            <div class="flex">
                <h3>Table des filières</h3>
                <div class="wrap">
                    <div class="search">
                        <input type="text" class="searchTerm" onkeyup="FiliereRecherche(this.value)"  placeholder="Recherche ....">
                ...
                <tbody id="Result">
                    ...
                    <c:forEach var="filiere" items="${ filieres }">
                        <tr>
                            ...
                            <td><c:out value="${ filiere.nom }" /></td>
                            <td><c:out value="${ filiere.nom_d }" /></td> 
                            <td><c:out value="${ filiere.date }" /></td>
...
// sidebar
            ...
            function FiliereRecherche(str) {
                const xmlhttp = new XMLHttpRequest();
                xmlhttp.onload = function () {
                    document.getElementById("Result").innerHTML = this.responseText;
                }
                xmlhttp.open("GET", "/AnnuaireENSProject/FiliereRecherche?mot=" + str);
                xmlhttp.send();
            }
        </script>
    </body>
