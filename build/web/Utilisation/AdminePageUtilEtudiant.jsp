    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <ul class="nav_list" >
                ...
                <br>    
                <li>
                    <a href="/ProjectAnnuaireENS/AdminePage/Utilisation/Etudiant" style="color:rgb(18, 142, 224);background:white;">
                ...
                <br>
                <li>
                    <a href="/ProjectAnnuaireENS/AdminePage/Utilisation/Departement">
                ...
                <c:forEach var="counter_variable_name" begin="0" end="5">
                    <tr>
                        ...
                        <td style="display: flex; justify-content: space-around;">
                            <a class="click" style="color: green;" >
